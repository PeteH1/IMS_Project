...
public class ItemControllerTest {
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, "Test item", 100));
	...
	public void testCreate() {
		...
		Mockito.when(utils.getInt()).thenReturn(VALUE);
	...
	public void testUpdate() {
		Item updated = new Item(1L, "Test item", 100);

		Mockito.when(this.utils.getLong()).thenReturn(1L);
		Mockito.when(this.utils.getString()).thenReturn(updated.getName());
		Mockito.when(this.utils.getInt()).thenReturn(updated.getValue());
